...
export default function NewTodoDialog({ onAdd, onCloseDialog }: NewTodoDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      const newTodo = { title, description, priority, id: Date.now().toString(), completed: false, createdAt: new Date() };
      onAdd(newTodo as TodoItem)
